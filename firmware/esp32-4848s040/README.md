...
- RGB auto-flush is disabled. Startup and real layout changes are composed as complete frames, while freshness, reset countdowns, pace badges, percentages, and bars are published as cache-aligned row regions. Routine minute ticks and data polls never clear or write back the full 480x480 framebuffer.
